...
func TestYoutube(t *testing.T) {
	...
	//I know it's horribly long, but because the styles get stored in a map then the map is for looped over, the style can be in any order so I have to account for all possiblities.
